...
?>
  <table style=";" class="table table-bordered  " id="dataTable" width="100%" cellspacing="0">
    ...
    <td  > <?php echo $row['date']; ?>  </td>
        ...
        <td>
            <form action="tea_edit.php" method="post">
                <input type="hidden" name="edit_tid" value="<?php echo $row['id']; ?>">
                <button   type="submit" name="edit_te" class="btn btn-success  "> EDIT</button>
            </form>
        </td>
