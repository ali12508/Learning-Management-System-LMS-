...
?>
  <table style="" class="table table-bordered   " id="dataTable" width="90%" cellspacing="0">
      ...
      <tr >
        ...
        <td>
            <form action="stu_edit.php" method="post">
                <input type="hidden" name="edit_sid" value="<?php echo $row['id']; ?>">
                <button   type="submit" name="edit_st" class="btn btn-success mt-5 "> EDIT</button>
            </form>
        </td>
