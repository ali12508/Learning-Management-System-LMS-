...
<div class="col-md-8">
      ...
      <form action="code.php" class="bg-info" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
                ...
                <input  style ="width:50%;" type="file" name="te_image" id="te_image"  required>
            </div>
 
            <button type="submit" name="registerteacher" class="btn btn-primary ml-5 text-white">Save</button>
