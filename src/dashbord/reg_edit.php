  ...
  if(isset($_POST['edit_ad']))
{
    $id=$_POST['edit_aid'];
     ...
     foreach($query_run as $row)
     {
      ...
      <input type="hidden" name="edit_add"value="<?php echo $row['id']; ?>" >
  <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="file" name="a_image" id="a_image" value="<?php echo $row['image']; ?>" class="form-control" placeholder="Enter Password">
            </div>
  ...
  if(isset($_POST['edit_st']))
{
    $id=$_POST['edit_sid'];
     ...
     foreach($query_run as $row)
     {
      ...
      <form action="code.php" method="POST" enctype="multipart/form-data">
      <input type="hidden" name="edit_sd"value="<?php echo $row['id']; ?>" >
  <div class="form-group">
                <label> Username </label>
                <input type="text" name="edit_username" value="<?php echo $row['username']; ?>" class="form-control" placeholder="Enter Username">
            </div>
            ...
            <div class="form-group">
                <label>upload image</label>
                <input type="file" name="s_image" id="s_image" value="<?php echo $row['image']; ?>" class="form-control" placeholder="Enter Password">
            </div>
            <a href="register.php" class="btn btn-danger">Cancel</a>
            <button type= "submit" name="update_st" class="btn btn-primary">Update</button>
   </form>
            <?php
        }
    }
